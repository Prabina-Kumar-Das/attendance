          ...
          <tr>
            <td style="padding:30px;">
              ...
              <p style="font-size:14px; color:#6b7280; line-height:1.7; margin:0 0 20px 0;">
                Our system has detected that your device has moved <strong>beyond the authorized geofence boundary</strong>. Immediate security verification is required.
              </p>
              ...
              <p style="font-size:13px; color:#374151; margin:0 0 12px 0; font-weight:600;">Enter this One-Time Password to verify:</p>
                ...
                <tr>
                  <td style="padding:14px 18px;">
                    <p style="margin:0; font-size:13px; color:#92400e; line-height:1.6;">
                      If you did not trigger this alert, your device may be compromised. Do NOT share this OTP with anyone.
                    </p>
                  </td>
                </tr>
              </table>
