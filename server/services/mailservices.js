...
<body style="margin:0; padding:0; background-color:#f4f4f4; font-family:Arial, sans-serif;">
        ...
        <table width="500" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 4px 10px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="padding:30px; color:#333;">
              <h3 style="margin-top:0;">Hello ${empname},</h3>
              <p style="line-height:1.6;">Your employee account has been successfully created. You can now access the system and start using the platform.</p>
              <p style="line-height:1.6;">Click the button below to login and get started:</p>
              ...
              <p style="line-height:1.6;">If you did not expect this account, please contact the administrator.</p>
              <p style="margin-top:30px;">Regards,<br/><strong>HR Team</strong></p>
            </td>
          </tr>
          <tr>
  ...
  console.log("✅ Registration mail sent to:", to, "| ID:", data.id);
  return data;
};
